...
(function (factory) {
  ...
  $.fn.simplyScroll = function(options) {
    return this.each(function() {
      ...
      if (typeof $(this).data('simplyScroll') === "undefined") {
        ...
        let simplyScroll = new $.simplyScroll(this, options);
  ...
  $.simplyScroll.fn.extend({
    init: function() {
      ...
      let addItems = Math.ceil(this.clipMax / this.itemMax);
      ...
      if (this.isAuto) {
        ...
        if (this.isAuto && this.o.pauseOnHover && !this.supportsTouch) {
          ...
          let touchStartPos, scrollStartPos;
    ...
    moveForward: function() {
      ...
      let frame = function(timestamp) {
        if (self.$clip[0]['scroll' + self.scrollPos] < (self.posMax-self.clipMax)) {
          let delta = (timestamp - (self.timestamp || timestamp)) * self.o.speed/self.o.frameRate;
